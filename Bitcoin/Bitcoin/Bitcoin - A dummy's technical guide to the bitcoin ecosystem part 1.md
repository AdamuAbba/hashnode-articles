...
But beyond all the hype, do you understand the technology and infrastructure Bitcoin is layered upon? My job in this series is not to overload you with too many technicalities but to give you enough dummed down knowledge to help lean your curiosity in the right direction.
...
Let's quickly talk about `hashing`. Hashing is a cryptographic process of passing a set of data through a secure hash algorithm to product an encrypted value called a `Digest`.
...
> Quick Note: the public/private key value pairs are generated through a cryptographic algorithm called an `Elliptic curve cryptographic function`. if you care to read more about it and loose a little bit of your sanity then check out [Elliptic Curve Cryptography Explained](https://learn.saylor.org/mod/book/view.php?id=36353#:~:text=to%20generate%20addresses.-,Elliptic%20Curve%20Cryptography%20Explained,-Elliptic%20curve%20cryptography).
...
And the final `digest` is passed through Base58Check encoding to improve human readability of the final address
...
This is the end of the first part of the series, I hope you were able to at least gain some surface-level understanding of Bitcoin. In the next part we'll be doing a deep dive of the different types of Bitcoin addresses mentioned above. Thank you.
